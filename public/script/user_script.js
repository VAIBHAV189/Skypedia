...
//------------------------------------------------For confirming and sending requests-------------------------------------------------------------//
...
$('#hide').hide()
    $('.bookFlight').click(function(){
       ...
       (
           ...
           <br> Enter total Seats that you want &nbsp &nbsp</span> <input type="Number" id="seats"  size="50" >&nbsp &nbsp 
           <button id="Booking_redirect">Start Booking</button> <br><br>`
       )
